...
-- ============================================================================
-- BƯỚC 0: SỬA SCHEMA CŨ NẾU CÓ (ALLOW NULL) VÀ XÓA DỮ LIỆU CŨ
-- ============================================================================
IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshPartner]') AND name = N'DatagramSize')
    ALTER TABLE [dbo].[EshPartner] ALTER COLUMN [DatagramSize] INT NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshPartner]') AND name = N'ResponseTimeoutSec')
    ALTER TABLE [dbo].[EshPartner] ALTER COLUMN [ResponseTimeoutSec] INT NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshPartner]') AND name = N'HeartbeatMaxSec')
    ALTER TABLE [dbo].[EshPartner] ALTER COLUMN [HeartbeatMaxSec] INT NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshPartner]') AND name = N'IsTlsEnabled')
    ALTER TABLE [dbo].[EshPartner] ALTER COLUMN [IsTlsEnabled] BIT NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshPartner]') AND name = N'UseTls')
    ALTER TABLE [dbo].[EshPartner] ALTER COLUMN [UseTls] BIT NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshPartner]') AND name = N'ProtocolProfile')
    ALTER TABLE [dbo].[EshPartner] ALTER COLUMN [ProtocolProfile] NVARCHAR(64) NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshMappingProfile]') AND name = N'VendorId')
    ALTER TABLE [dbo].[EshMappingProfile] ALTER COLUMN [VendorId] NVARCHAR(64) NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshMappingProfile]') AND name = N'DatatypeId')
    ALTER TABLE [dbo].[EshMappingProfile] ALTER COLUMN [DatatypeId] NVARCHAR(64) NULL;

-- EshSubscription old schema columns ALLOW NULL
IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshSubscription]') AND name = N'Guaranteed')
    ALTER TABLE [dbo].[EshSubscription] ALTER COLUMN [Guaranteed] BIT NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshSubscription]') AND name = N'VendorId')
    ALTER TABLE [dbo].[EshSubscription] ALTER COLUMN [VendorId] NVARCHAR(64) NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshSubscription]') AND name = N'QueueName')
    ALTER TABLE [dbo].[EshSubscription] ALTER COLUMN [QueueName] NVARCHAR(256) NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshSubscription]') AND name = N'RetryCount')
    ALTER TABLE [dbo].[EshSubscription] ALTER COLUMN [RetryCount] INT NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshSubscription]') AND name = N'MaxRetryAttempts')
    ALTER TABLE [dbo].[EshSubscription] ALTER COLUMN [MaxRetryAttempts] INT NULL;

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[EshSubscription]') AND name = N'QoS')
...
-- ============================================================================
IF NOT EXISTS (SELECT * FROM sys.views WHERE name = 'vw_TrafficFlow')
...
IF NOT EXISTS (SELECT * FROM sys.views WHERE name = 'vw_VmsStatus')
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'tbl_Incident')
...
IF NOT EXISTS (SELECT * FROM sys.views WHERE name = 'vw_Weather')
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'tbl_ParkingLot')
...
IF NOT EXISTS (SELECT * FROM sys.views WHERE name = 'vw_VehicleDetection')
