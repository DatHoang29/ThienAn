...
| `ISAPI-Videowall-Controller/VideoWall_ISAPI_API_List.md` | 239 dòng | Chuyển đổi từ `_source/VideoWall_ISAPI_API_List.xlsx` — bảng đầy đủ 116 API (11 nhóm 9.7.1→9.7.11), mỗi API gắn nhãn Dùng chính / Tùy chọn-mở rộng / Ngoài phạm vi | Tra cứu dạng bảng đầy đủ, đối chiếu API nào thật sự dùng cho dự án — nguồn sự thật cho `videowall_kich_ban_test.md` |
