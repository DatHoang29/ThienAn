...
| A | `doc/transcript/16-09-2026-refactor-backend-sharedata-worker.md` | full | 12 KB | Thống nhất Kiến trúc & Định hướng Refactor Backend Worker: Bẻ nhỏ pipeline thành 3 process đơn nhiệm (Lấy DB -> Mapping -> Sender), cô lập lỗi tại bước mapping, DTO Context WrapperData | `../Plan/_source/audio/16-09-2026-refactor-backend-sharedata-worker.m4a` |
| A | `Plan/sharedata-outbound-plan.md` | full | — | Kế hoạch luồng gửi ShareData outbound (tài liệu SỐNG, cập nhật liên tục — bản mới nhất: lần 6, 2026-09-15) | Biên soạn nội bộ, đối chiếu code + test thật |
