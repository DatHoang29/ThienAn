...
tier: A
read: full
source: ../../../Plan/_source/audio/16-09-2026/16-09-2026-review-frontend-sharedata.m4a
date: 16-09-2026
...
participants:
  ...
  - Hiếu (Dev ShareData / Trình chiếu UI)
...
> **Ghi chú:** Bản ghi được tổng hợp và xử lý trực tiếp qua phương thức **Gemini Multimodal Native Audio Understanding** từ tệp ghi âm cuộc họp nội bộ ngày 16/09/2026 (`9.24, 16 thg 9_.m4a`). Nội dung tập trung vào buổi review trực tiếp màn hình Web Frontend phân hệ **ShareData (ESHARE)** giữa Anh Sơn (Tech Lead), Hiếu và Đạt (phân hệ ShareData), rà soát chi tiết các bất cập UI/UX, chuẩn hóa luồng nghiệp vụ cấu hình đối tác, gói tin và engine ánh xạ dữ liệu (mapping).
...
> - **Hiếu:** Dev ShareData (người trình chiếu màn hình và demo thao tác)
...
- **Hiếu:** Dạ, cái này là một cái...
- **Anh Sơn:** Sửa nó lại cho nó... Rồi cái Cảnh báo kìa có chạy được không?
- **Hiếu:** Không, Cảnh báo hiện tại là bỏ. Cảnh báo là khi nào mà thật á thì nó mới raise cảnh báo lên.
- **Anh Sơn:** Nhưng mà nó có test được không? Nó có dữ liệu thật không?
- **Hiếu:** Trong code hiện tại các bạn đang comment hết rồi.
...
- **Hiếu:** Có có có, cái đó thoải mái anh.
...
- **Hiếu:** Cấu hình hệ thống...
- **Anh Sơn:** Nó bị đâu? Nhiều khi của em sửa gì bây giờ kéo qua thử coi...
- **Hiếu:** Đâu có bị đâu anh!
- **Anh Sơn:** Nó bị cái chỗ phân trang đó, nó bị đè lên đó! Cái này chỉnh lại nó bị cái gì rồi.
- **Hiếu:** Đây nè, nó đang bị cái này đè lên nè.
- **Anh Sơn:** Không kéo nó rộng ra được hả?
- **Hiếu:** Không kéo được anh ơi, fix cứng luôn rồi anh ơi. `Placeholder` là phải chọn trường.
- **Anh Sơn:** Đâu?
- **Hiếu:** Đúng luôn! Chỗ trường đó phải chọn trường chứ!
...
- **Hiếu:** Để em cắt nguyên màn hình đó luôn, em đánh dấu lại.
...
- **Hiếu:** Đang thêm vô đúng không anh?
...
- **Hiếu:** Cấu hình này là sẽ khai báo đối tác. Xong rồi khai báo cái gói tin mà đối tác sẽ gửi. Khai báo đối tác nè, khai báo những cái đăng ký gửi...
- **Anh Sơn:** Đối tác là cái gì?
- **Hiếu:** Đối tác là những cái partner mà mình sẽ gửi gói tin, sẽ chia sẻ dữ liệu cho mình hoặc mình chia sẻ dữ liệu cho người ta.
- **Anh Sơn:** Tạm ổn. Rồi, ở phần đăng ký gửi này là sao?
- **Hiếu:** Ở phần đăng ký gửi này là mình sẽ đăng ký những cái... đăng ký mà mình muốn gửi đi cho họ hoặc mình nhận về, theo từng cái gói tin cho từng đối tác. Thì nó sẽ đăng ký theo... có kiểu lịch, ví dụ mình gửi đi á...
- **Anh Sơn:** Trời đất ơi! Từ từ, em giải thích tiếp: Trong loại gói tin nó sẽ có cái gì?
- **Hiếu:** Trong loại gói tin nó sẽ có những cái tin... những cái dữ liệu của gói tin đó.
...
- **Hiếu:** Dữ liệu gói tin này là những dữ liệu gói tin được quy định ở trong phần cấu hình gói tin, được seed DB sẵn.
...
- **Hiếu:** Cái ưu tiên này sẽ là cái để hệ thống biết là gói tin nào được ưu tiên gửi trước nếu như nó đang trong một cái hàng đợi...
...
- **Hiếu:** Dạ, chọn theo ngày là chọn ngày nào được gửi, màu xanh là sẽ chọn ngày gửi, giờ gửi là sẽ cấu hình là vào ngày đó gửi lúc mấy giờ.
...
- **Hiếu:** Tiếp tục là phần Mapping...
- **Anh Sơn:** Đi theo đúng cấu trúc, đừng có đi nhảy lung tung rồi tí nữa rối!
- **Hiếu:** Dạ, Mapping nè. Đầu tiên là vô Cấu hình trước đúng không? Xong cấu hình gói tin. Thì sau khi có 2 thông tin này rồi, bước tiếp theo là mình sẽ tiến hành đi cấu hình mapping dữ liệu.
...
- **Hiếu:** Tiếp, thì đầu tiên vô phần Ánh xạ dữ liệu, tổng quan phần này nó sẽ là một cái phần ánh xạ để nó cấu hình cái dữ liệu bên mình qua dữ liệu đối tác, thay đổi những cái trường dữ liệu ở trong một gói tin nhất định.
- **Anh Sơn:** Là sao? Không hiểu! Giải thích lại từ từ coi!
- **Hiếu:** Phần ánh xạ này nó là một phần để mình cấu hình dữ liệu gửi đi hoặc nhận về theo... theo cái dữ liệu mà đối tác mong muốn.
...
- **Hiếu:** Dạ rồi, để xíu em viết tóm tắt lại.
- **Anh Sơn:** Tóm lại là sao? Sure kèo luôn, Như nó sẽ hỏi tóm lại là sao?
- **Hiếu:** Hôm qua em có gửi trước cho chị Như một bản rồi á anh.
...
- **Hiếu:** Chiều gửi với chiều nhận hôm qua em thử ok anh. Gửi đi nhận về ok, hai chiều cũng ok. Nó map với thằng CodeSet cũng ok luôn. Nhận về nó sẽ revert lại cái cấu trúc.
- **Anh Sơn:** Rồi!
- **Hiếu:** Đầu tiên là một cái tab thông tin chung là để mình khai báo hồ sơ ánh xạ... Ở đây sẽ có danh sách chọn gói tin.
- **Anh Sơn:** Thiếu cái mã kìa! Thiếu cái mã gói tin kìa. Tại vì trong bên này nó quy định theo mã, `101`, `102` đó.
- **Hiếu:** Tại vì nó đang dùng hai cái bảng khác nhau á, thì sau sẽ chuyển đổi qua hết một bảng. Trường mã hồ sơ ánh xạ ở đây nó sẽ tự động sinh theo...
- **Anh Sơn:** Cho mình chọn, theo mã kết hợp với mã. Cái partner kia đặt cái mã test đúng không? Nó làm đảo lộn hết trơn...
- **Hiếu:** Cái mã này sẽ tự sinh theo mã đối tác, mã gói tin và mã chiều (In/Out).
- **Anh Sơn:** Rồi, tại sao chỗ đó bị trống?
- **Hiếu:** Tại vì nó đang thêm mới anh. Giờ em qua bên này em sửa có dữ liệu sẵn nè.
- **Anh Sơn:** Khung đầu ra là cái gì?
- **Hiếu:** Bên phía bên phải là bảng ánh xạ theo cấu trúc của đối tác.
- **Anh Sơn:** Ba chấm (...) đó là cái gì?
- **Hiếu:** Ba chấm là thêm mấy cái... Đối với những cái mà hệ thống nhận diện nó là Header thì sẽ chỉ có 2 option đó là: Bỏ khóa này khi gửi đi và Giá trị mặc định khi gửi đi.
...
- **Hiếu:** Thì em đang tính thêm nó vô đây nè.
...
- **Hiếu:** Giống như bên kia demo là có nguyên một cái cụm Meta đó...
...
- **Hiếu:** Không, nếu mà vậy á thì từ từ nha anh. Tại vì hiện tại là anh Đạt ảnh sẽ gửi nguyên cái cụm này nó là một cái raw content luôn. Tụi em sẽ nhận về như thế này. Còn những cái thằng ở ngoài á, nó sẽ là cái Meta, cần thì em hiển thị những cái trường này lên để cho người ta cấu hình trên này.
...
- **Hiếu:** Em biết cái Meta của anh rồi.
...
- **Hiếu:** Có thể là drop-down, hoặc có thể là bấm vào nó sẽ hiện nguyên một cái Modal để mình chọn.
...
- **Hiếu:** Khóa này cấu hình nó đang là không gửi đi nên là nó không cho chọn.
...
- **Hiếu:** Hiểu hiểu, ok anh.
- **Anh Sơn:** Tự dưng đưa qua thành một cái nghĩa khác á!
- **Hiếu:** Dạ dạ, ok ok... Vậy thì em bỏ cái option đó đi.
- **Anh Sơn:** Rồi, tiếp phần data...
- **Hiếu:** Ở phần data này nó sẽ có một cái chức năng nữa là "Nạp lại trường gói tin". Là nó sẽ tự động mapping những cái field của gói tin hệ thống đã được khai báo với lại cái cấu trúc JSON mà mình đã tạo lên đây.
- **Anh Sơn:** Tự nạp lại là cái gì? Đổi tên nó lại! Tự nhiên nạp lại trường dữ liệu nghe nó kỳ quá.
- **Hiếu:** Nếu mà JSON không có là nó sẽ không tự động map. Bấm một cái là phân tích...
...
- **Hiếu:** Nút của em là em mới nói á.
...
- **Hiếu:** Ok anh. Tại vì khi mà ấn phân tích này là nó đã tự động ánh xạ so với cái gói tin rồi, so với gói tin đã chọn bên này nè.
- **Anh Sơn:** Rồi sao không ghi là: "Đã khớp 6/12 trường"?
- **Hiếu:** Dạ...
- **Anh Sơn:** Chứ ghi "Đã khớp" nghe kỳ quá!
- **Hiếu:** Đảo sao nãy giờ nó ghi sai data... Đau bụng quá! Thôi đi vệ sinh nha.
