...
| 9 | API Reference (Vendor Spec) | [09-api-reference.md](09-api-reference.md) | 1.670 KB |
| 10 | How-To Video Guidance | [10-how-to-video-guidance.md](10-how-to-video-guidance.md) | 1 KB |

### Dữ liệu đo thiết bị thật (nguồn sự thật hạng 1)

| File | Mô tả | Bản ghi |
| --- | --- | --- |
| [`../../data/logs-api/session-20260903-real.json`](../../data/logs-api/session-20260903-real.json) | Log thiết bị thật ngày 03/09, đã loại mock | 955 |
| [`../../data/logs-api/session-20260904-real.json`](../../data/logs-api/session-20260904-real.json) | Log thiết bị thật ngày 04/09, đã loại mock | 1158 |
| [`../../data/logs-api/README.md`](../../data/logs-api/README.md) | Hướng dẫn đọc log và nhận diện mock | — |

> **Thứ tự ưu tiên:** data/logs-api (hành vi thực tế) → `09-api-reference.md` (đặc tả hãng). Khi mâu thuẫn, log thắng.
