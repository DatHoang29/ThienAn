...
| C | `_source/audio/21-09-2026/21-09-2026-sharedata-phan-1-ui-mapping.m4a` | never | 2.8 MB | Audio cuộc họp Phần 1: UI & Luồng Mapping (05:53) | → bản `.md`: `../ShareData/doc/transcript/21-09-2026-hoan-thien-mapping-va-gui-noi-duoi-sharedata.md` |
| C | `_source/audio/21-09-2026/21-09-2026-sharedata-phan-2-gui-noi-duoi-va-du-lieu-moi.m4a` | never | 8.3 MB | Audio cuộc họp Phần 2: Cơ chế gửi nối đuôi theo mốc & xử lý dữ liệu mới (17:15) | → bản `.md`: `../ShareData/doc/transcript/21-09-2026-hoan-thien-mapping-va-gui-noi-duoi-sharedata.md` |
| C | `_source/audio/21-09-2026/21-09-2026-sharedata-phan-3-mapping-profile.m4a` | never | 4.0 MB | Audio cuộc họp Phần 3: Sinh mã hồ sơ & luồng 1 chiều (08:17) | → bản `.md`: `../ShareData/doc/transcript/21-09-2026-hoan-thien-mapping-va-gui-noi-duoi-sharedata.md` |
| C | `_source/audio/21-09-2026/21-09-2026-sharedata-phan-4-tong-ket.m4a` | never | 1.6 MB | Audio cuộc họp Phần 4: Tổng kết & chốt luồng (03:21) | → bản `.md`: `../ShareData/doc/transcript/21-09-2026-hoan-thien-mapping-va-gui-noi-duoi-sharedata.md` |
| C | `_source/audio/21-09-2026/21-09-2026-sharedata-clip-gui-noi-duoi.m4a` | never | 17.0 MB | Audio trích đoạn giải thích cơ chế gửi nối đuôi (09:09) | → bản `.md`: `../ShareData/doc/transcript/21-09-2026-hoan-thien-mapping-va-gui-noi-duoi-sharedata.md` |
