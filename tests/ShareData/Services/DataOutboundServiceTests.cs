...
namespace Tests.Modules.ShareData.Infrastructure.Services.DataOutbound
{
    ...
    public partial class DataOutboundServiceTests(Host host)
    {
        ...
        {
            public Task<DataOutboundExtractionResult> Extract(ISqlSugarClient db, ShareDataSubscription sub, ShareDataPacket packet, Action<string, object?[]>? onLogWarning = null)
        ...
        public void MapCode_StandardMappingAndDefaultFallback_BehavesCorrectly_Test()
        {
            ...
            var r1 = DataOutboundService.MapCode(codeValues, "1");
            Assert.Equal("slow", r1);

            var r2 = DataOutboundService.MapCode(codeValues, "2");
            Assert.Equal("normal", r2);

            var r3 = DataOutboundService.MapCode(codeValues, "999");
        ...
        */
        ...
        {
            var result = DataOutboundService.ToNcName(raw, "default_field");
        ...
        public void SerializeEnvelopeToXmlBytes_ProducesWellFormedXmlWithoutBom_Test()
        {
            ...
            // Act
            var xmlBytes = DataOutboundService.SerializeEnvelopeToXmlBytes(header, data);
        ...
        public void SerializeDataToXmlBytes_MatchesFragmentForPayloadHash_Test()
        {
            ...
            // Act
            var fragmentBytes = DataOutboundService.SerializeDataToXmlBytes(data);
