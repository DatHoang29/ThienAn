...
| ID | Loại dữ liệu | Chế độ truyền | Độ trễ tối đa |
|----|---------------|---------------|---------------|
| 101 | Thông tin giao thông (lưu lượng, tốc độ, mật độ) | Liên tục (continuous) | < 30 giây |
| 102 | Thông tin VMS (biển báo điện tử) | Theo sự kiện | < 30 giây |
| 103 | Thông tin sự cố xảy ra | Theo sự kiện (event-triggered) | < 30 giây |
| 104 | Thông tin sự cố (bổ sung) | Theo yêu cầu | < 5 phút |
| 105 | Thông tin tình trạng đường | Theo yêu cầu (on-demand) | < 5 phút |
| 106 | Thông tin thời tiết | Theo yêu cầu (on-demand) | < 5 phút |
| 107 | Thông tin quản lý đường | Tĩnh (static) | — |
| 108 | Thông tin đỗ xe | Liên tục (continuous) | < 30 giây |
| 109 | Thông tin phát hiện xe | Liên tục (continuous) | < 30 giây |
| 110 | Thông tin hình ảnh/video | Liên tục | — |
| 111 | Thông tin khác | — | — |
