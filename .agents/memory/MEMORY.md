...
- [Đặt tên method không có suffix "Async"](feedback-no-async-suffix-naming.md) — code MỚI mình viết tuyệt đối không dùng "Async"; code cũ/thư viện/người khác viết trước đó cứ kệ, giữ nguyên
