...
- `tests/ShareData/Services/DataOutboundServiceTests.cs::DataOutboundServiceTests.ProcessBatchSubscriptions_IncrementalCatchUp_AfterIdle_ExportsEveryNewRowExactlyOnce_Test`
- `tests/ShareData/Services/DataOutboundServiceTests.cs::DataOutboundServiceTests.ProcessBatchSubscriptions_WhenShapeHasHeaderAndRecordArray_WritesSingleHeaderInPayload_Test`
- `tests/ShareData/Services/DataOutboundServiceTests.cs::DataOutboundServiceTests.ProcessBatchSubscriptions_WhenPacketCodeHasSuffixLikeStagingDb_ResolvesHandlerAndExportsSuccessfully_Test`
