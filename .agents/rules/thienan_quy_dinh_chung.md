...
6.  **QUY ĐỊNH CLEAN CODE & COMMENT**: Không viết comment XML dư thừa (`/// <summary>...`) hoặc comment giải thích rườm rà trên Class, Method, Property trừ khi thật sự cần thiết. Giữ code tinh gọn, trực diện, tự giải thích.
